...
<html>
    <head>
        ...
        <title>STYLISH CLOTHS STORE</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h2 style="color:balck">Welcome to our Stylish To Make Stylish Women Boutique Shop!</h2> 
                    <p><i style="color:balck">...We are proudly presenting the best quality of Women's clothes for you. No need to hunt around, we have all in one place...</i></p></p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/traditional1.jpg" alt="blue">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:brown">Light blue with flower saree</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/traditional2.jpg" alt="kerala">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:purple">Kerala saree</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/traditional3.jpg" alt="sreya">
                            </a>
							<br>
                            <center>
                                <div class="caption">
                                    <h3 style="color:brown">Sreya saree</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/traditional4.jpg" alt="krish">
                            </a>
							<br>
							<br>
							<br>
                            <center>
                                <div class="caption">
                                    <h3 style="color:blue">Negaakrish saree</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/traditional5.jpg" alt="burukah">
                            </a>
							<br>
							<br>
							<br>
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:purple">Shruthi Burukah </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chudi1.jpg" alt="sunny" background-size:"20%">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:orange">Sunny Chudi</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chudi2.JPG" alt="nazhi">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:blue">Modern Nazhi Chudi</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chudi4.jpg" alt="Favre Leuba">
                            </a>
							<br>
							<br>
							<br>
                            <center>
                                <div class="caption">
                                    <h3 style="color:red">Anarkali Kurta</h3>
				 ...
				 <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/n2.jpg" alt="nighty">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:brown">Boomish Nighties</h3>
                                    <p>Price: Rs. 900.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/n3.jpg" alt="n3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:black">Modern Night Dress</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:brown">White Chudi Top</h3>
                                    <p>Price: Rs. 600.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:red">Stylish Swimming Dress</h3>
                   ...
                   <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/join2.jpg" alt="join2">
                            </a>
							<br>
							<br>
                            <center>
                                <div class="caption">
                                    <h3 style="color:red">All in One TShirts& Watch and Heals</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:blink" >Multicolored Sining Gown</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:green">Casual Night Dress</h3>
                                    <p>Price: Rs. 900.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                 	...
                 	<div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:blue">Girls Pencil Skirt</h3>
                                    <p>Price: Rs. 1000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
					...
					<div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:brown">New Model Baby Gown(Color:Rose)  </h3>
                                    <p>Price: Rs. 3000.00 per 1 item</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:brown">Combo Offer for young girls </h3>
                                    <p>Price: Rs. 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
